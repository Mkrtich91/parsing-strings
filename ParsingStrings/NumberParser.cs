    ...
    public static class NumberParser
    {
        ...
        public static uint ParseUnsignedInteger(string? str)
        {
            try
            {
                ...
                uint result = uint.Parse(str, CultureInfo.InvariantCulture);
                return result;
            }
            catch (FormatException)
            {
            ...
            {
                return uint.MaxValue; // Value exceeds the range of uint
            }
        }
        ...
        public static byte ParseByte(string? str)
        {
            ...
            try
            {
                byte result = byte.Parse(str, CultureInfo.InvariantCulture);
                return result;
            }
            catch (FormatException)
            {
        ...
        public static bool TrySignedByte(string str, out sbyte result)
        {
            ...
            if (sbyte.TryParse(str, out sbyte parsedValue))
            {
                result = parsedValue;
                return true;
            }
        ...
        public static sbyte ParseSignedByte(string? str)
        {
            ...
            {
                throw new OverflowException($"The input string '{str}' represents a value outside the valid range for a signed byte.");
            }
        }
        ...
        public static ulong ParseUnsignedLong(string? str)
        {
            ...
            {
                throw new OverflowException($"The input string '{str}' represents a value outside the valid range for an unsigned long integer.");
            }
        }
    }
}
